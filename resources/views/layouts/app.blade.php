...
<head>
    ...
    <title>@yield('title') | SIAKAD SMK Bakti Idhata</title>
                                ...
                                <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                    <div class="user-menu d-flex">
                                        <div class="user-name text-end me-3">
                                            ...
                                            <p class="mb-0 text-sm text-gray-600">{{ ucfirst(str_replace('_', ' ', Auth::user()->role)) }}</p>
                                        </div>
                                        <div class="user-img d-flex align-items-center">
                                            <div class="avatar avatar-md">
                                                <img src="{{ asset('assets/images/faces/user-default.png') }}">
                                            </div>
                                        </div>
                                    </div>
                                </a>
