<table>
    <thead>
        <tr>
            <th colspan="4" style="text-align: center; font-weight: bold; font-size: 14pt;">REKAPITULASI NILAI SISWA (RAPOR)</th>
        </tr>
        <tr>
            <th colspan="4" style="text-align: center; font-weight: bold; font-size: 12pt;">SMK BAKTI IDHATA</th>
        </tr>
        <tr></tr>
        <tr>
            <th style="font-weight: bold;">Nama Peserta Didik</th>
            <th colspan="1">: {{ $siswa->nama_lengkap }}</th>
            <th style="font-weight: bold;">Kelas</th>
            <th colspan="1">: {{ $kelas->nama_kelas }}</th>
        </tr>
        <tr>
            <th style="font-weight: bold;">NIS / NISN</th>
            <th colspan="1">: {{ $siswa->nis }} / {{ $siswa->nisn ?? '-' }}</th>
            <th style="font-weight: bold;">Tahun Akademik</th>
            <th colspan="1">: {{ $tahun_akademik->tahun_ajaran }} ({{ $tahun_akademik->semester }})</th>
        </tr>
        <tr></tr>
        <tr>
            ...
            <th style="border: 1px solid #000; font-weight: bold; text-align: center; background-color: #D3D3D3;">Capaian Kompetensi</th>
        </tr>
    </thead>
    <tbody>
        @foreach($nilais as $n)
        <tr>
            ...
            <td style="border: 1px solid #000;">{{ $n->capaian_kompetensi ?? '-' }}</td>
        </tr>
        @endforeach
    </tbody>
</table>
